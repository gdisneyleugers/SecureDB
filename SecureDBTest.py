...
# Encrypt Data
data = encrypt('signing_key','table_{0}'.format(int(cc)), insert_test='passed!', random_data="{}".format(SaltGen(256)), secureDB="is Awesome!")
# Write Data
DbWrite('test.sdb', data)
print spacer
#  Insert Test is a test to test writing to DB
print "INSERT TEST: "
print "Entry [{1}]: {0}".format(data,int(cc))
# Decrypt Data
raw = str(decrypt('signing_key',data))
print "Decrypted [{1}] : {0}".format(raw,int(cc))
print spacer
